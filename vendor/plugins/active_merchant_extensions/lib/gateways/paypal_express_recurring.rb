am_path = Bundler.load.specs.find {|s| s.name == 'activemerchant' }.full_gem_path + '/lib/active_merchant/billing/gateways'
require am_path + '/paypal/paypal_common_api'
require am_path + '/paypal/paypal_express_response'
require am_path + '/paypal_express_common'
